...
def _extract_twilio_error_code(text: str) -> Optional[str]:
    """Best-effort extraction of Twilio error codes like '21404' from response text."""
    if not text:
        return None
...
def send_whatsapp_message(
    ...
    """Send a WhatsApp message via Twilio. Returns Twilio SID or raises TwilioError."""
    # Ensure the numbers have the required "whatsapp:" prefix
    ...
    try:
        ...
        # keep structured Twilio errors intact
        raise
